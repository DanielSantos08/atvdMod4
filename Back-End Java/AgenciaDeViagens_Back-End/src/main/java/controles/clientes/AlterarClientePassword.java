...
/**
 * Servlet implementation class AlterarClientePassword
 */
@WebServlet("/AlterarClientePassword")
public class AlterarClientePassword extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AlterarClientePassword() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		daoCliente.alterarPassword(cliente);
