...
/**
 * Servlet implementation class AlterarClienteNascimento
 */
@WebServlet("/AlterarClienteNascimento")
public class AlterarClienteNascimento extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AlterarClienteNascimento() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		daoCliente.alterarNascimento(cliente);
