...
/**
 * Servlet implementation class AlterarClienteEndereco
 */
@WebServlet("/AlterarClienteEndereco")
public class AlterarClienteEndereco extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AlterarClienteEndereco() {
        super();
...
RequestDispatcher despacho = null;
		...
		daoCliente.alterarEndereco(cliente);
